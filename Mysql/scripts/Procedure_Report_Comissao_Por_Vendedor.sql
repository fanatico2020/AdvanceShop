...
DELIMITER 
CREATE PROCEDURE RelatorioComissaoPorVendedor(in Vendedor varchar(45),in DataInicial DATETIME ,in DataFinal DATETIME)
BEGIN

select v.idvendas as Venda,v.totalfinal as TotalVenda,v.clientespessoas_idclientespessoas as CodigoCliente,
...
inner join itensvendas i on v.idvendas = i.vendas_idvendas where 
...
call RelatorioComissaoPorVendedor('SORAIA','2021/01/01','2021/08/06');
